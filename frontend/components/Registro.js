...
function App() {
  ...
  return (
    ...
    <br></br>
    <br></br>
    <div className="min-h-full flex items-center justify-center bg-gray-40 sm:px-6 lg:px-8">
      
		<div className="max-w-md w-full space-y-8 rounded-2xl p-8 border-4 border-indigo-600">
			<div>
        ...
        required
        className="p-8 border border-indigo-700 appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
        />
					</div>
          <div>
            ...
            required
            className="min p-8 border border-indigo-700 appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto" width="20pt" height="20pt" version="1.1" viewBox="0 0 700 700">
              <g>
