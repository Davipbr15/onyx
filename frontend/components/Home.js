...
import head from '../img/headset.png';
...
<div className='pt-8'>
    <div className="h-32 w-full bg-gradient-to-bl from-indigo-800 to-roxo">
      ...
      <div className="grr max-w-7xl pt-20 mx-auto text-center m-5">
      ...
      <section className="relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <div className="py-24 md:py-36">
            ...
            <h1 className="text-center mb-9 text-2xl font-semibold text-white">
